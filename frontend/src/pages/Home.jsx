          ...
          <Row>
            <Col lg="6">
              <div className="hero__content">
                ...
                <p>
                  Đến với HIAN Tour, quý khách hàng sẽ tận hưởng những tour du lịch
                  tốt nhất với chất lượng và giá cả siêu hợp lý. Từng yêu cầu dù nhỏ nhất,
                   chúng tôi luôn cố gắng thực hiện tốt nhất có thể.
                </p>
              </div>
            </Col>
        ...
        <Container>
          <Row>
            <Col lg="3">
              ...
              <h2 className="services__title">Chúng tôi sở hữu tour du lịch tốt nhất</h2>
            </Col>
            <ServiceList />
          </Row>
        </Container>
